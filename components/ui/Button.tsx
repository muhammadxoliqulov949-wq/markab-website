 ...
 */
const base =
  'inline-flex items-center justify-center gap-2 font-semibold rounded-btn transition-ctrl disabled:opacity-50 disabled:pointer-events-none focus-visible:z-10 select-none active:scale-[0.98] active:translate-y-[0.5px]';
...
const sizes: Record<Size, string> = {
  ...
  xl: 'h-14 px-8 text-[1rem] rounded-[14px] sm:text-[1.0625rem]',
};
